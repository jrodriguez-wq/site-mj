...
export const SITEMAP_CONFIG = {
  mainRoutes: [
    ...
    { path: "/new-homes-for-sale", priority: 0.95, changeFrequency: "weekly" as const },
    { path: "/models", priority: 0.95, changeFrequency: "weekly" as const },
    { path: "/rent-to-own", priority: 0.85, changeFrequency: "weekly" as const },
    { path: "/rto-application", priority: 0.8, changeFrequency: "monthly" as const },
