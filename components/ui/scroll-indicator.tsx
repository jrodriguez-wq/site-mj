  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center gap-1.5 px-2.5 py-2 rounded-full bg-slate-900/90 dark:bg-slate-950/80 backdrop-blur-md border border-slate-700/50 shadow-2xl group-hover:bg-slate-900/90 dark:group-hover:bg-slate-950/95 group-hover:border-slate-600/70 transition-all duration-300">
