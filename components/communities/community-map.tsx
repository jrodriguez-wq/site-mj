...
// URLs de Google Maps embebido para cada comunidad
const MAP_EMBEDS = {
  ...
  // Mapa de Lehigh Acres mostrando toda la zona
...
export const CommunityMap = ({ community }: CommunityMapProps) => {
  ...
  // Construir URL con el idioma correcto
  const mapUrl = useMemo(() => {
    const baseUrl = MAP_EMBEDS[community];
    const lang = language === "es" ? "es" : "en";
    // Reemplazar el idioma en la URL
    return baseUrl.replace(/!1s(en|es)!2s(co|us)/g, `!1s${lang}!2s${lang === "es" ? "us" : "us"}`);
  }, [community, language]);
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-8">
            ...
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
              Encuentra nuestra comunidad en el mapa
            </p>
          </div>
            ...
            <CardContent className="p-0">
              <div className="relative w-full h-[450px] md:h-[500px] lg:h-[600px]">
                <iframe
                  ...
                  title={`Mapa de ${community === "labelle" ? "LaBelle" : "Lehigh Acres"}`}
                />
              </div>
            </CardContent>
          </Card>
