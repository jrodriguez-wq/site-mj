...
export const InfiniteTextCarousel = () => {
  ...
  return (
    <section className="py-6 sm:py-8 md:py-10 pt-16 lg:py-12 bg-primary/5 border-y-2 border-primary/20 overflow-hidden relative flex items-center justify-center">
