...
export const RentalApplicationContent = () => {
  ...
  const documents = useMemo(() => [
    {
      icon: FileText,
      name: t("rentToOwn.documents.taxes.name") || "Tax Returns",
      description: t("rentToOwn.documents.taxes.description") || "Last 2 years (W2 or 1099)",
    },
    {
      icon: FileCheck,
      name: t("rentToOwn.documents.payStubs.name") || "Pay Stubs",
      description: t("rentToOwn.documents.payStubs.description") || "Last 30 days",
    },
    {
      icon: FileText,
      name: t("rentToOwn.documents.bankStatements.name") || "Bank Statements",
      description: t("rentToOwn.documents.bankStatements.description") || "Last 60 days",
    },
    {
      icon: Shield,
      name: t("rentToOwn.documents.id.name") || "Driver's License or ID",
      description: t("rentToOwn.documents.id.description") || "Valid identification",
    },
    {
      icon: FileText,
      name: t("rentToOwn.documents.ssn.name") || "Social Security or ITIN",
      description: t("rentToOwn.documents.ssn.description") || "Identification number",
    },
  ], [t]);
  ...
  const processSteps = useMemo(() => [
    {
      step: 1,
      icon: FileText,
      title: t("rentToOwn.process.step1.title") || "Submit Documents",
      description: t("rentToOwn.process.step1.description") || "Submit the required documents to begin your application.",
    },
    {
      step: 2,
      icon: FileCheck,
      title: t("rentToOwn.process.step2.title") || "Complete Application",
      description: t("rentToOwn.process.step2.description") || "Complete the RTO application ($50 per applicant).",
    },
    {
      step: 3,
      icon: Handshake,
      title: t("rentToOwn.process.step3.title") || "Interview and Review",
      description: t("rentToOwn.process.step3.description") || "Interview and document review by our team.",
    },
    {
      step: 4,
      icon: Key,
      title: t("rentToOwn.process.step4.title") || "Sign Contract",
      description: t("rentToOwn.process.step4.description") || "Sign the contract and pay the deposit.",
    },
    {
      step: 5,
      icon: Home,
      title: t("rentToOwn.process.step5.title") || "Move-in",
      description: t("rentToOwn.process.step5.description") || "Choose the move-in date and start living in your new home!",
    },
  ], [t]);
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center space-y-4 max-w-4xl mx-auto">
              <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-semibold mb-4">
                ...
                <span suppressHydrationWarning>{t("rentalApplication.title") || "Rental Application"}</span>
              </div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tight leading-tight px-4" suppressHydrationWarning>
                {t("rentalApplication.heroTitle") || "Apply for Your Dream Home"}
              </h1>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4" suppressHydrationWarning>
                {t("rentalApplication.heroSubtitle") || "Start your journey to homeownership with our Rent to Own program. Apply today and take the first step towards owning your new home."}
              </p>
            </div>
          </div>
        </section>
          ...
          <PageContent size="lg">
            <div className="text-center space-y-4 mb-12">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground" suppressHydrationWarning>
                {t("rentalApplication.whyApply") || "Why Apply for Our Rent to Own Program?"}
              </h2>
                ...
                <Card className="border-2 border-primary/20 shadow-2xl bg-gradient-to-br from-background via-background to-primary/5">
                  <CardHeader className="text-center space-y-3 pb-4 p-6 md:p-8">
                    <CardTitle className="text-2xl sm:text-3xl md:text-4xl font-black leading-tight" suppressHydrationWarning>
                      {t("rentalApplication.formTitle") || "Rental Application Form"}
                    </CardTitle>
                    ...
                    <CardDescription className="text-sm md:text-base lg:text-lg pt-2 text-muted-foreground leading-relaxed" suppressHydrationWarning>
                      {t("rentalApplication.formDescription") || "Fill out the form below to start your application. Our team will review your information and get back to you within 24-48 hours."}
                    </CardDescription>
                ...
                <Card className="border-2 shadow-lg">
                  <CardHeader>
                    <CardTitle className="text-xl md:text-2xl font-bold flex items-center gap-3" suppressHydrationWarning>
                      ...
                      {t("rentToOwn.documents.title") || "Required Documents"}
                    </CardTitle>
                    <CardDescription suppressHydrationWarning>
                      {t("rentToOwn.documents.subtitle") || "Please have these documents ready when you apply"}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="border-2 shadow-lg bg-gradient-to-br from-primary/5 via-primary/10 to-background">
                  <CardHeader>
                    <CardTitle className="text-xl md:text-2xl font-bold flex items-center gap-3" suppressHydrationWarning>
                      ...
                      {t("rentalApplication.communities.title") || "Available Communities"}
                    </CardTitle>
                    <CardDescription suppressHydrationWarning>
                      {t("rentalApplication.communities.description") || "We build beautiful homes in these amazing communities"}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="border-2 shadow-lg">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold flex items-center gap-3" suppressHydrationWarning>
                      ...
                      {t("rentToOwn.process.title") || "Application Process"}
                    </CardTitle>
                    <CardDescription suppressHydrationWarning>
                      {t("rentToOwn.process.subtitle") || "Simple steps to begin your path to homeownership"}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-6">
                ...
                <Card className="border-2 shadow-lg">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold flex items-center gap-3" suppressHydrationWarning>
                      ...
                      {t("rentalApplication.requirements.title") || "Application Requirements"}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <p className="text-sm text-muted-foreground" suppressHydrationWarning>
                        {t("rentalApplication.requirements.description") || "To apply, you'll need to meet these basic requirements:"}
                      </p>
                ...
                <Card className="border-2 shadow-lg bg-gradient-to-br from-primary/5 to-background">
                  <CardHeader>
                    <CardTitle className="text-xl font-bold flex items-center gap-3" suppressHydrationWarning>
                      ...
                      {t("rentalApplication.needHelp.title") || "Need Help?"}
                    </CardTitle>
                    <CardDescription suppressHydrationWarning>
                      {t("rentalApplication.needHelp.description") || "Our team is here to assist you with any questions"}
                    </CardDescription>
                  </CardHeader>
